...
export class NewhighlightDialogComponent implements OnInit {
  ...
  constructor(public dialogRef: MatDialogRef<NewhighlightDialogComponent>, private toastr : ToastrService, private postService : PostService,
  ...
  isEmptyImage(){
    ...
    if (this.newHighStories.length === 0) {
      ...
      console.log(this.newHighStories)
      let stories = []
      let storiesString = []
      let userDTO = new SaveHighlight()
      userDTO.highlightName = this.highlightForm.controls.name.value
