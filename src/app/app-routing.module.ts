...
import { AdminAgentRequestComponent } from './admin-agent-request/admin-agent-request/admin-agent-request.component';
...
const routes: Routes = [
  ...
  {
    path: "admin/agentRequests",
    component: AdminAgentRequestComponent,
    canActivate : [AuthGuard],
    data : {roles: [Role.Admin]}
  }
