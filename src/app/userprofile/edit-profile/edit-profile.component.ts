...
export class EditProfileComponent implements OnInit {
  ...
  removePhoto(){
    ...
    this.imgFile= this.emptyProfile;
    this.fileName= this.emptyProfile;

  }
  isEmptyImage(){
    if(this.imgFile=== this.emptyProfile){
      return true;
    }else{
      return false;
    }
